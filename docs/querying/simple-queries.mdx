...
title: Loading Related Data - Linq EF
description: Different strategies for loading related data with Linq Entity Framework
author: roji
ms.date: 9/11/2020
...
Linq Entity Framework allows you to use the navigation properties in your model to load related entities. There are three common O/RM patterns used to load related data.
