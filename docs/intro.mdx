...
Linq Framework (LEF) 是轻量化、可扩展、[开源](https://github.com/hanxinimm/LinqEntityFramework)和跨平台的 Entity Framework 数据访问技术，该框架源于LINQ语法的便捷和EF Core框架的设计思想，而衍生出的一种结合两者优点的ORM访问框架。
