...
import DataAnnotationsFunctionNameAndSchemaContainsParameters from '!!raw-loader!../../../../../static/samples/Modeling/EntityTypes/DataAnnotations/FunctionNameAndSchemaContainsParameters.cs';
...
<Tabs groupId="operating-code">
  <TabItem value="Annotations" label="数据注解">
    <CodeBlock title="C#" language="csharp" metastring='{8,9}' showLineNumbers>{DataAnnotationsFunctionNameAndSchema}</CodeBlock>
  </TabItem>
  <TabItem
    value="Fluent"
    label="Fluent API"
...
<Tabs groupId="operating-code">
  <TabItem value="Annotations" label="数据注解">
    <CodeBlock title="C#" language="csharp" metastring='{8,9}' showLineNumbers>{DataAnnotationsFunctionNameAndSchemaContainsParameters}</CodeBlock>
  </TabItem>
  <TabItem
    value="Fluent"
    label="Fluent API"
