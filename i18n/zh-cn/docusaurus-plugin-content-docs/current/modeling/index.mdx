...
title: 概述
description: 使用实体框架核心创建和配置模型概述
author: 韩鑫
ms.date: 10/13/2020
uid: 核心/建模/索引
---

import DataAnnotationsAnnotations from '!!raw-loader!../../../../../static/samples/Modeling/EntityProperties/DataAnnotations/Annotations.cs';
...
<CodeBlock title="C#" language="csharp" metastring='{12-12}' showLineNumbers>{DataAnnotationsAnnotations}</CodeBlock>
